...
public class LoggerAspect {
    ...
    @Around("execution(* com.application.services.*.*(..))")
    ...
    @Around("@annotation(com.application.interfaces.LogAspect)")
    ...
    @AfterThrowing(value = "execution(* com.application.services.*.*(..))",throwing = "ex")
    ...
    @AfterReturning(value = "execution(* com.application.services.*.*(..))",returning = "retVal")
